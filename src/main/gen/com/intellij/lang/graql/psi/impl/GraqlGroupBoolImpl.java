...
public class GraqlGroupBoolImpl extends ASTWrapperPsiElement implements GraqlGroupBool {

  public GraqlGroupBoolImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitGroupBool(this);
  }
