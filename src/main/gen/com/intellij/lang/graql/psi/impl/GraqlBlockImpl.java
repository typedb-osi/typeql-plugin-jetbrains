...
public class GraqlBlockImpl extends ASTWrapperPsiElement implements GraqlBlock {

  public GraqlBlockImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlBlockContents getBlockContents() {
    return findNotNullChildByClass(GraqlBlockContents.class);
  }
