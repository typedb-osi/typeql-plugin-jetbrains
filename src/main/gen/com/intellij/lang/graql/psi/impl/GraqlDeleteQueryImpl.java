...
public class GraqlDeleteQueryImpl extends ASTWrapperPsiElement implements GraqlDeleteQuery {

  public GraqlDeleteQueryImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlMatchPart getMatchPart() {
    return findNotNullChildByClass(GraqlMatchPart.class);
  }

  @Override
  @Nullable
  public GraqlVariables getVariables() {
    return findChildByClass(GraqlVariables.class);
  }
