...
public class GraqlClusterParamImpl extends ASTWrapperPsiElement implements GraqlClusterParam {

  public GraqlClusterParamImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitClusterParam(this);
  }
