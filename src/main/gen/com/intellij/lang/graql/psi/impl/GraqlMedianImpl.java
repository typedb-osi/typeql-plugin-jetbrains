...
public class GraqlMedianImpl extends ASTWrapperPsiElement implements GraqlMedian {

  public GraqlMedianImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitMedian(this);
  }
  ...
  public GraqlOfList getOfList() {
    return findNotNullChildByClass(GraqlOfList.class);
  }
