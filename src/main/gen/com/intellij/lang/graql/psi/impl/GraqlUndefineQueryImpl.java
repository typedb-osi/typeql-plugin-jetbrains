...
public class GraqlUndefineQueryImpl extends ASTWrapperPsiElement implements GraqlUndefineQuery {

  public GraqlUndefineQueryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitUndefineQuery(this);
  }
