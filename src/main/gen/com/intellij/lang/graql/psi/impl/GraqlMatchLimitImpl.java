...
public class GraqlMatchLimitImpl extends ASTWrapperPsiElement implements GraqlMatchLimit {

  public GraqlMatchLimitImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitMatchLimit(this);
  }
