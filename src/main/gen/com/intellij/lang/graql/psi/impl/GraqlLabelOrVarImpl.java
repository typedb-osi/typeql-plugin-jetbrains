...
public class GraqlLabelOrVarImpl extends ASTWrapperPsiElement implements GraqlLabelOrVar {

  public GraqlLabelOrVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitLabelOrVar(this);
  }
