...
public class GraqlDefineQueryImpl extends ASTWrapperPsiElement implements GraqlDefineQuery {

  public GraqlDefineQueryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitDefineQuery(this);
  }
