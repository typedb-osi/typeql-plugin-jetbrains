...
public class GraqlValueOrVarImpl extends ASTWrapperPsiElement implements GraqlValueOrVar {

  public GraqlValueOrVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitValueOrVar(this);
  }
