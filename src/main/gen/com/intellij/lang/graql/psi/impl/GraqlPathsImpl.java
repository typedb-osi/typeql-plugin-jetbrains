...
public class GraqlPathsImpl extends ASTWrapperPsiElement implements GraqlPaths {

  public GraqlPathsImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraqlIdentifier> getIdentifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraqlIdentifier.class);
  }
