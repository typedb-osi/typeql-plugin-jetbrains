...
object TypeQLPsiElementFactory {
    fun createTypeProperty(project: Project?, name: String?): PsiTypeQLNamedElement {
        ...
        return file.firstChild.firstChild.firstChild.lastChild.lastChild.firstChild.firstChild.firstChild.firstChild
    ...
    fun createRelatesTypeProperty(project: Project?, name: String?): PsiTypeQLNamedElement {
        ...
        val file = createFile(project, dummyText)
        return file.firstChild.firstChild.firstChild.lastChild.lastChild.firstChild.firstChild.lastChild as PsiTypeQLNamedElement
    }
