...
public class GraqlMatchOrderByImpl extends ASTWrapperPsiElement implements GraqlMatchOrderBy {

  public GraqlMatchOrderByImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitMatchOrderBy(this);
  }
