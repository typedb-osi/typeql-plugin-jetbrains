...
public class GraqlAggregateTypeWithVarImpl extends ASTWrapperPsiElement implements GraqlAggregateTypeWithVar {

  public GraqlAggregateTypeWithVarImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitAggregateTypeWithVar(this);
  }
