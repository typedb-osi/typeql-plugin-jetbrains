...
public class GraqlEqualityExpressionImpl extends ASTWrapperPsiElement implements GraqlEqualityExpression {

  public GraqlEqualityExpressionImpl(ASTNode node) {
    super(node);
  }
