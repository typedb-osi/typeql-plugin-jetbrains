...
public class GraqlRelationStatementImpl extends ASTWrapperPsiElement implements GraqlRelationStatement {

  public GraqlRelationStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraqlRelationList> getRelationListList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraqlRelationList.class);
  }
