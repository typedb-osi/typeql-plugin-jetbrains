...
public class GraqlCommitExpressionImpl extends ASTWrapperPsiElement implements GraqlCommitExpression {

  public GraqlCommitExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitCommitExpression(this);
  }
