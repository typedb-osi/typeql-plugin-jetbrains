...
public class GraqlEntitySubExpressionsImpl extends ASTWrapperPsiElement implements GraqlEntitySubExpressions {

  public GraqlEntitySubExpressionsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitEntitySubExpressions(this);
  }
  ...
  public GraqlRelatesExpression getRelatesExpression() {
    return findNotNullChildByClass(GraqlRelatesExpression.class);
  }
