...
public class GraqlAggregateExpressionImpl extends ASTWrapperPsiElement implements GraqlAggregateExpression {

  public GraqlAggregateExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GraqlAggregateTypeExpr getAggregateTypeExpr() {
    return findNotNullChildByClass(GraqlAggregateTypeExpr.class);
  }
