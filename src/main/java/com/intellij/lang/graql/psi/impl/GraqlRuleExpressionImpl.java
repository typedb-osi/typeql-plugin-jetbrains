...
public class GraqlRuleExpressionImpl extends ASTWrapperPsiElement implements GraqlRuleExpression {

  public GraqlRuleExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GraqlWhenThenExpression getWhenThenExpression() {
    return findNotNullChildByClass(GraqlWhenThenExpression.class);
  }
