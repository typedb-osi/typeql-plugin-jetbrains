...
public class GraqlVarPatternsImpl extends ASTWrapperPsiElement implements GraqlVarPatterns {

  public GraqlVarPatternsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitVarPatterns(this);
  }
