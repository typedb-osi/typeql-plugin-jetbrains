...
public class GraqlRoleExpressionImpl extends ASTWrapperPsiElement implements GraqlRoleExpression {

  public GraqlRoleExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitRoleExpression(this);
  }
