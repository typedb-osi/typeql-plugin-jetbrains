...
public class GraqlElsePartialImpl extends ASTWrapperPsiElement implements GraqlElsePartial {

  public GraqlElsePartialImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitElsePartial(this);
  }
