...
public class GraqlAggregateTypeImpl extends ASTWrapperPsiElement implements GraqlAggregateType {

  public GraqlAggregateTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitAggregateType(this);
  }
