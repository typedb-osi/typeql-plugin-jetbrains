...
public class GraqlPlaysExpressionImpl extends ASTWrapperPsiElement implements GraqlPlaysExpression {

  public GraqlPlaysExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitPlaysExpression(this);
  }
