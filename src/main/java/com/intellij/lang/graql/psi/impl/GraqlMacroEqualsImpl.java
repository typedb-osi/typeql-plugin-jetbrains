...
public class GraqlMacroEqualsImpl extends ASTWrapperPsiElement implements GraqlMacroEquals {

  public GraqlMacroEqualsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitMacroEquals(this);
  }
