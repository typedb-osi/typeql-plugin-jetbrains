...
public class GraqlAttributeExpressionImpl extends ASTWrapperPsiElement implements GraqlAttributeExpression {

  public GraqlAttributeExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlDatatypeExpression getDatatypeExpression() {
    return findNotNullChildByClass(GraqlDatatypeExpression.class);
  }
