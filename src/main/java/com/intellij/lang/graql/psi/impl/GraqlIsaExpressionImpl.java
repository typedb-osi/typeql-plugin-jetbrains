...
public class GraqlIsaExpressionImpl extends ASTWrapperPsiElement implements GraqlIsaExpression {

  public GraqlIsaExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitIsaExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<GraqlRelationField> getRelationFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraqlRelationField.class);
  }
