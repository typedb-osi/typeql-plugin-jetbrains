...
public class GraqlHasValueExpressionImpl extends ASTWrapperPsiElement implements GraqlHasValueExpression {

  public GraqlHasValueExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitHasValueExpression(this);
  }
