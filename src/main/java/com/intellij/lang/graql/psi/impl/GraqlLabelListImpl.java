...
public class GraqlLabelListImpl extends ASTWrapperPsiElement implements GraqlLabelList {

  public GraqlLabelListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GraqlLabel> getLabelList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GraqlLabel.class);
  }
