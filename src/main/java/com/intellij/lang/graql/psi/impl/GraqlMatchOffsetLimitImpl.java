...
public class GraqlMatchOffsetLimitImpl extends ASTWrapperPsiElement implements GraqlMatchOffsetLimit {

  public GraqlMatchOffsetLimitImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitMatchOffsetLimit(this);
  }
  ...
  public GraqlMatchLimit getMatchLimit() {
    return findChildByClass(GraqlMatchLimit.class);
  }

  @Override
  @NotNull
  public GraqlMatchOffset getMatchOffset() {
    return findNotNullChildByClass(GraqlMatchOffset.class);
  }
