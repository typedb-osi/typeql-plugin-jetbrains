...
public class GraqlElseIfPartialImpl extends ASTWrapperPsiElement implements GraqlElseIfPartial {

  public GraqlElseIfPartialImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitElseIfPartial(this);
  }
  ...
  @Override
  @NotNull
  public GraqlBool getBool() {
    return findNotNullChildByClass(GraqlBool.class);
  }
