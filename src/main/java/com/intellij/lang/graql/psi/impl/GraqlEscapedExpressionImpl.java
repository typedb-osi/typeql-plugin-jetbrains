...
public class GraqlEscapedExpressionImpl extends ASTWrapperPsiElement implements GraqlEscapedExpression {

  public GraqlEscapedExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GraqlVisitor visitor) {
    visitor.visitEscapedExpression(this);
  }
  ...
  public GraqlUntypedExpression getUntypedExpression() {
    return findNotNullChildByClass(GraqlUntypedExpression.class);
  }
