...
public class GraqlDeleteExpressionImpl extends ASTWrapperPsiElement implements GraqlDeleteExpression {

  public GraqlDeleteExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlVarField getVarField() {
    return findNotNullChildByClass(GraqlVarField.class);
  }
