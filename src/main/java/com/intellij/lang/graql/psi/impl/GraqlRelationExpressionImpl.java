...
public class GraqlRelationExpressionImpl extends ASTWrapperPsiElement implements GraqlRelationExpression {

  public GraqlRelationExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlRelationField getRelationField() {
    return findNotNullChildByClass(GraqlRelationField.class);
  }

  @Override
  @NotNull
  public GraqlVar getVar() {
    return findNotNullChildByClass(GraqlVar.class);
  }
