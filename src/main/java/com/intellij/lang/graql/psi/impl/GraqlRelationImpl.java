...
public class GraqlRelationImpl extends ASTWrapperPsiElement implements GraqlRelation {

  public GraqlRelationImpl(ASTNode node) {
    super(node);
  }
  ...
  public GraqlIdentifierExpr getIdentifierExpr() {
    return findNotNullChildByClass(GraqlIdentifierExpr.class);
  }
